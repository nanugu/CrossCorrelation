...
#include "yoco.i"
Data=fits_read("Fits/Two_step_vs_SNR_solar.fits");
...
limits, 0, 800, -0.01, 0.45;

pdf, "Sigma_SNR_Solar_TwoStep";
...
limits, -0.01,800, -0.02, 0.1; 

pdf, "Bias_SNR_Solar_TwoStep";
...
limits, -0.02, 0.35, -0.02, 0.2;

pdf, "Bias_Sigma_Solar_TwoStep";
