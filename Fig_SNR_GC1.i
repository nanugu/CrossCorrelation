...
#include "yoco.i"
Data=fits_read("Fits/Two_step_vs_SNR_GC.fits");
Data=abs(Data(,:));
...
limits, -0.01, 42, -0.01, 0.22;
pdf, "Sigma_SNR_GC_TwoStep";
...
limits, -0.01, 42, -0.01, 0.1;
pdf, "Bias_SNR_GC_TwoStep";
...
limits, -0.01, 0.25, -0.01, 0.2;
pdf, "Bias_Sigma_GC_TwoStep";
